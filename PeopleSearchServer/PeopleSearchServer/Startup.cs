...
namespace PeopleSearchServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            PeopleSearchContext.ConnectionString = Configuration.GetConnectionString( "AzurePeopleSearch" );
            ImageContext.ConnectionString = Configuration.GetConnectionString( "AzurePeopleSearch" );
            ...
            string allowedClients = (string) Configuration.GetValue<string>("AllowedClients");
